      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="lesson_menu.php" >
                <i class="ni ni-ungroup text-orange"></i>
                <span class="nav-link-text">บทเรียน</span>
              </a>

            </li>
            <li class="nav-item">
              <a class="nav-link" href="test_menu.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="subject.php" >
                ...
                <span class="nav-link-text">สาระการเรียนรู้</span>
              </a>
            ...
            <li class="nav-item">
              <a class="nav-link" href="credit.php">
                ...
                <span class="nav-link-text">ผู้จัดทำ</span>
              </a>
